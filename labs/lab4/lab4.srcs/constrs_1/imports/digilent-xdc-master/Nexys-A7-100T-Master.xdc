...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { A_in }];
IO_L24N_T3_RS0_15 Sch=A
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { B_in }];
IO_L3N_T0_DQS_EMCCLK_14 Sch=B
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { C_in }];
IO_L6N_T0_D08_VREF_14 Sch=C_in
...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { C_out }];
IO_L18P_T2_A24_15 Sch=C_out
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { sum }]; 
IO_L24P_T3_RS1_15 Sch=sum
